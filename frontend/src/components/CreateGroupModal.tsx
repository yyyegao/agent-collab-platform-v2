      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">创建群聊</h2>
            <button
              onClick={onClose}
          ...
          {/* 群聊名称 */}
          <div className="mb-4">
            <label className="label-feishu">群聊名称 *</label>
            <input
              type="text"
              value={groupName}
          ...
          {/* 群描述 */}
          <div className="mb-5">
            <label className="label-feishu">群描述</label>
            <textarea
              value={description}
              onChange={e => setDescription(e.target.value)}
              placeholder="这个群聊的用途是..."
              className="input-feishu min-h-[60px] resize-none"
            />
          </div>

          {/* 选择 Agent */}
          <div>
            <label className="label-feishu">
              选择 Agent (至少 2 个) *
          ...
          <div className="flex gap-3 pt-6">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-2.5 rounded-xl bg-gray-100 text-gray-600 font-medium hover:bg-gray-200 transition-colors"
            >
              取消
            </button>
            <button
              ...
              className="flex-1 px-4 py-2.5 rounded-xl bg-primary text-white font-medium hover:bg-primary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed btn-feishu"
            >
              创建群聊
            </button>
          </div>
